...
class ManagesControllerTest < ActionController::TestCase
  ...
  test "should create manage" do
    assert_difference('Manage.count') do
      post :create, manage: { ingredient: @manage.ingredient, name: @manage.name, pictures: @manage.pictures, price: @manage.price }
    end
  ...
  test "should update manage" do
    patch :update, id: @manage, manage: { ingredient: @manage.ingredient, name: @manage.name, pictures: @manage.pictures, price: @manage.price }
    assert_redirected_to manage_path(assigns(:manage))
  end
